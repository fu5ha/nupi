...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		promptGuidelines: [
			...
			"External shell tools like ripgrep, fd/find, git, etc. can be accessed from nushell and should be prefixed with ^, for example `^rg`",
			"Prefer single-quoted strings when passing string arguments to external commands in nushell (for example, `^rg 'Some\\String' ./some/path`)",
